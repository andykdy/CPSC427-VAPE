...
bool ScoreBackground::init(vec2 screen, float height) {
...
//		TexturedVertex vertexData[totalSprites * 4];
    ...
    Vertex vertices[4];
//    vertices[0].position = {600, height-100, -0.02f};
//    vertices[0].color = {0,0,0};
//    vertices[1].position = {700, height-100, -0.02f};
//    vertices[1].color = {0,0,0};
//    vertices[2].position = {700, height-50, -0.02f};
//    vertices[2].color = {0,0,0};
//    vertices[3].position = {600, height-50, -0.02f};
//    vertices[3].color = {0,0,0};

    vertices[0].position = {0, 40, -0.02f};
    vertices[0].color = {0,0,0};
    vertices[1].position = {200, 40, -0.02f};
    vertices[1].color = {0,0,0};
    vertices[2].position = {200, 0, -0.02f};
    vertices[2].color = {0,0,0};
