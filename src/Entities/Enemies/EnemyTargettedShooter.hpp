...
#ifndef VAPE_ENEMYTARGETTEDSHOOTER_HPP
#define VAPE_ENEMYTARGETTEDSHOOTER_HPP

#include "Enemy.hpp"

class EnemyTargettedShooter : public Enemy{
...
#endif //VAPE_ENEMYTARGETTEDSHOOTER_HPP
